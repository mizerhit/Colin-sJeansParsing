...
class DataAccessObject:
    ...
    def __create_tables(self):
        self.__cursor.execute("DROP TABLE IF EXISTS Things")
    ...
    def save_thing(self, name, colour, price, discount):
        self.__cursor.execute('INSERT INTO Things (thing, color, price, discount) VALUES (?, ?, ?, ?)', (name, colour, price, discount))
